...
Para modificar el valor de la posición de un vector simplemente le asignamos el nuevo valor:
...
Podemos acceder a las posiciones de una lista empleando el operador `[]`, pero en ese caso cada uno de los elementos que devuelva va a ser una lista  con un único elemento:
