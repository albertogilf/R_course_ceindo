...
La función `select()` permite seleccionar columnas a partir de su nombre. Por ejemplo, quedémonos solo con la información relativa a los sépalos Y a la especie, y omitamos la información de los pétalos:
