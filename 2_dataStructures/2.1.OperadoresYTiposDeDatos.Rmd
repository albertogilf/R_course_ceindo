...
num_carateres  
```
La función `substring()` permite obtener una sub cadena de caracteres indicando las posiciones del primer y último carácter:
...
TRUE | TRUE
```
Por supuesto, estos operadores pueden aplicarse sobre variables:
