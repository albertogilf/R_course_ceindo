...
Para solicitar la entrada de datos por teclado podemos utilizar principalmente las funciones `scan()` y `readline()`. La función `print()` no se utiliza para leer datos, sino para mostrar resultados por pantalla.
