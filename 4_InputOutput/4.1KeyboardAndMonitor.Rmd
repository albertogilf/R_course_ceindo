...
1. ¿Cómo puedo leer datos de tipo lista con la función scan? Guarda en una variable con cuatro listas diferentes los valores "est1 est2 est3 est4 est5 est6 est7 est8 est9 est10 est11 est12 est13 est14 est15 est16 est17 est18 est19 est20". 
...
```
2. Quiero leer un vector con los elementos 1, 2, 3, 4 y 5 utilizando la función scan. Recuerda que se puede hacer un cambio de tipo de lista a vector mediante la función unlist
