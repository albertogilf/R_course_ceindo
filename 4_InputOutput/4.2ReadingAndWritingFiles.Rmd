...
```{r}
install.packages("xlsx", repos = "http://cran.us.r-project.org") # install the package from CRAN
...
Posteriormente, vamos a aplicar un filtro sobre el conjunto de datos iris y escribirlo en los diferentes formatos. El filtro a utilizar será que la especie sea versicolor y que Petal.Width esté entre 1.0 y 1.3 o que la especia sea setosa y la longitud del pétalo (Petal.Length) esté entre 1.5 y 2.0. 
